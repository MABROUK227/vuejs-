    ...
    <v-row>
      <v-col cols="4">
        <v-img
          class="img-overly"
          rounded="lg"
          src="../../assets/images/feature/home2.jpg"
          height="593"
          cover
        >
        </v-img>
